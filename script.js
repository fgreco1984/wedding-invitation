...
function forceStartLanguageRotation() {
  const titles = [
    "Scegli la lingua",
    "Choose your language",
    "Оберіть мову"
  ...
  function start() {
    ...
    if (window.forcedRotation) clearInterval(window.forcedRotation);

    window.forcedRotation = setInterval(function () {
      i = (i + 1) % titles.length;
      el.textContent = titles[i];
    }, 2000);
  }
...
function resetLanguageScreen() {
  ...
  if (homeScreen) {
    ...
    homeScreen.classList.remove("fade-in", "fade-out");
    homeScreen.removeAttribute("style");
  }
  ...
  if (languageScreen) {
    ...
    languageScreen.style.zIndex = "30";
  }
...
function forceStartLanguageRotation() {
  ...
  if (forcedRotation) clearInterval(forcedRotation);

  forcedRotation = setInterval(function () {
    i = (i + 1) % titles.length;
    el.textContent = titles[i];
  }, 2000);
}
...
function forceOpenHome(lang) {
  ...
  if (img) {
    if (lang === "it") img.src = "assets/home-luxury-it.jpg";
    if (lang === "en") img.src = "assets/home-luxury-en.jpg";
    if (lang === "ua") img.src = "assets/home-luxury-ua.jpg";
  }
